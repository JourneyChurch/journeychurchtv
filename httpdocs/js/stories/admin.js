$(document).ready(function () {
  ...
  function printStories(data) {
    ...
    $(storyDivs).each(function(index) {
      ...
      $("#save-"+ids[index]).click(function() {
        ...
        $.ajax({
          type: "POST",
          url: "/php/stories/admin_update.php",
          data: {
            id : id,
            remove : remove,
  ...
  $.ajax({
    type: "POST",
    url: "/php/stories/get_stories.php",
    success: function(data) {
      printStories(data);
    }
  });
