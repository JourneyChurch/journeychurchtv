/**
 * jquery.calendario.js v1.0.0 - WITH MODIFICATIONS BY MIKE WALKER
...
;( function( $, window, undefined ) {
	...
	$.Calendario.prototype = {
		...
		_getBody : function() {
			...
			var html = '<div class="fc-body"><div class="fc-row group">',
				// fill in the days
				day = 1;
			...
			for ( var i = 0; i < 7; i++ ) {
				...
				for ( var j = 0; j <= 6; j++ ) {
					...
					var pos = this.startingDay - this.options.startIn,
						...
						// Next line added by Mike Walker
				...
				if (day > monthLength) {
					...
					html += '</div><div class="fc-row group">';
				}
