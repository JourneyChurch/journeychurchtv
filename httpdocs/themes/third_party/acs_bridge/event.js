(function() {
	...
	templates['event'] = template(function (Handlebars,depth0,helpers,partials,data) {
		...
		function program8(depth0,data) {
			var buffer = "", stack1;
			buffer += "<div id='theregistration'><h2>Registration Options</h2>";
			...
			if(stack1 || stack1 === 0) { buffer += stack1; }
			buffer += "<div class='register-button'><a href='https://secure.accessacs.com/access/login_guest.aspx?sn=106649' target='_blank'><button class='pull-right'><i class='fa fa-ticket'></i> Register Now</button></a></div></div>";
			return buffer;
		}
