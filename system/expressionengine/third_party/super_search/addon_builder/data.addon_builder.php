...
class Addon_builder_data_super_search
{
	/**
	 * local cache array
	 * @var array
	...
	public function __call($method, $args)
	{
		...
		if ( ! in_array($method, $this->aob_non_static_friendly) AND
			 is_callable(array('Addon_builder_super_search', $method)))
		{
			return call_user_func_array(array('Addon_builder_super_search', $method), $args);
		}
	}
	//end __call
