...
<div>
	...
	$this->table->add_row('<label for="db_backup_method">'.lang('db_backup_method').'</label><div class="subtext">'.lang('db_backup_method_instructions').'</div>', form_dropdown('db_backup_method', $db_backup_methods, $settings['db_backup_method'], 'id="db_backup_method"'. $settings_disable));
	$this->table->add_row('<label for="db_restore_method">'.lang('db_restore_method').'</label><div class="subtext">'.lang('db_restore_method_instructions').'</div>', form_dropdown('db_restore_method', $db_restore_methods, $settings['db_restore_method'], 'id="db_restore_method"'. $settings_disable));
