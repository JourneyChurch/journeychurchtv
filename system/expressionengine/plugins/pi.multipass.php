...
class Multipass {
	...
	public function Multipass()
	{
		...
		{
			$this->return_data = "You haven't entered your ChOP URL";
			return;
		}
				
		if (!$TMPL->fetch_param('key'))
		{
			$this->return_data = "You haven't entered your ChOP Key";
			return;
		}
		
		if (!$TMPL->fetch_param('sso_key'))
		{
			$this->return_data = "You haven't entered your ChOP API Key";
			return;
		}
		...
		$tender_params = array(
			...
			'first_name'	=> $SESS->userdata['screen_name'],
			'last_name'		=> $SESS->userdata['screen_name'],
			'nickname'		=> $SESS->userdata['screen_name'],
